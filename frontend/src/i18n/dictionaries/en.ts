export const en = {
  ...
  admin: {
    ...
    roleAdmin: 'Admin',
    accessLabel: 'Access',
    accessFull: 'Everything',
    accessTopicsOnly: 'DevOps programme only',
    accessCertsOnly: 'Certificates only',
    accessCustom: 'Selected tracks only',
    accessGroupCerts: 'Certificates',
    accessGroupTopics: 'DevOps topics',
    accessCustomEmpty: 'Pick at least one track',
