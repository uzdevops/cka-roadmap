...
function LoginForm() {
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      // Someone sent here mid-journey goes back where they were headed;
      // everyone else lands on the grid, the front door of the platform.
      router.push(href(params.get('next') ?? '/tracks'));
    } catch (err) {
